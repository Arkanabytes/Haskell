...
--tiene que cumplirse la propiedad triangular; es decir, longuitud de cada lado tiene que ser un menor que la suma de los otros dos lados.
---Definir la funcion triangular tal que(triangular a b c) se verifica si a, b y c cumplen la propiedad triangular Por, ejemplo.
